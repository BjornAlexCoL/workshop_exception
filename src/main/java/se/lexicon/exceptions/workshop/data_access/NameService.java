...
public class NameService {
	    ...
	    public void addFemaleFirstName(String name) throws DuplicateNameException {
	    	if (femaleFirstNames.stream().filter(s->s.toString().equalsIgnoreCase(name))!=null)
	    ...
	    public void addMaleFirstName(String name)throws DuplicateNameException {
			if (maleFirstNames.stream().filter(s->s.toString().equalsIgnoreCase(name))!=null)
				throw new DuplicateNameException(name);
	    ...
	    public void addLastName(String lastName) throws DuplicateNameException {
	    	...
	    	if (lastNames.stream().filter(s ->s.toString().equalsIgnoreCase(lastName))!=null)
	...
	private class DuplicateNameException extends Exception {
	    	String name;
